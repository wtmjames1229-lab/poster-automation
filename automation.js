...
"Snoopy and Woodstock at a windswept headland, Peter Severin Kroyer art style painting with luminous Danish coast",
    // ── 200 Snoopy and Woodstock activity posters with text ──
  "Snoopy and Woodstock surfing a wave, vintage activity poster with 'SURFING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock hiking a mountain, vintage activity poster with 'HIKING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock camping under stars, vintage activity poster with 'CAMPING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock fishing at sunrise, vintage activity poster with 'FISHING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock skiing a snowy slope, vintage activity poster with 'SKIING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock riding a hot air balloon, vintage activity poster with 'BALLOONING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock sailing at sea, vintage activity poster with 'SAILING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock playing tennis, vintage activity poster with 'TENNIS' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock cycling through a park, vintage activity poster with 'CYCLING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing yoga in a garden, vintage activity poster with 'YOGA' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock swimming in the ocean, vintage activity poster with 'SWIMMING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock kayaking down a river, vintage activity poster with 'KAYAKING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing a picnic in a meadow, vintage activity poster with 'PICNIC' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock flying a kite on a hill, vintage activity poster with 'KITE FLYING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock playing soccer on a field, vintage activity poster with 'SOCCER' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock snowboarding a halfpipe, vintage activity poster with 'SNOWBOARDING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock running on a beach, vintage activity poster with 'RUNNING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock rock climbing a cliff, vintage activity poster with 'ROCK CLIMBING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock stargazing with a telescope, vintage activity poster with 'STARGAZING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock gardening in spring, vintage activity poster with 'GARDENING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock dancing at a festival, vintage activity poster with 'DANCING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock reading under a tree, vintage activity poster with 'READING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock cooking in a kitchen, vintage activity poster with 'COOKING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock baking in a warm kitchen, vintage activity poster with 'BAKING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock playing baseball, vintage activity poster with 'BASEBALL' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock playing basketball, vintage activity poster with 'BASKETBALL' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock painting on canvas, vintage activity poster with 'PAINTING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock playing guitar at a campfire, vintage activity poster with 'MUSIC' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock skydiving over countryside, vintage activity poster with 'SKYDIVING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock scuba diving in the ocean, vintage activity poster with 'DIVING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a beach volleyball match, vintage activity poster with 'VOLLEYBALL' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock snowshoeing in the woods, vintage activity poster with 'SNOWSHOEING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock building a sandcastle, vintage activity poster with 'BEACH DAY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock paddle boarding at golden hour, vintage activity poster with 'PADDLEBOARDING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a marathon finish line, vintage activity poster with 'MARATHON' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing archery in a forest, vintage activity poster with 'ARCHERY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock ice skating on a frozen lake, vintage activity poster with 'ICE SKATING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock paragliding over mountains, vintage activity poster with 'PARAGLIDING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock dog sledding across the snow, vintage activity poster with 'DOG SLEDDING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock zip-lining through a jungle, vintage activity poster with 'ZIP LINING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock whitewater rafting, vintage activity poster with 'RAFTING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock playing chess in a park, vintage activity poster with 'CHESS' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock horseback riding on a trail, vintage activity poster with 'HORSEBACK RIDING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a sunrise walk on the beach, vintage activity poster with 'BEACH WALK' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock birdwatching in a forest, vintage activity poster with 'BIRDWATCHING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing pottery at a wheel, vintage activity poster with 'POTTERY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a farmers market, vintage activity poster with 'FARMERS MARKET' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making homemade pizza, vintage activity poster with 'PIZZA NIGHT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock on a road trip in a car, vintage activity poster with 'ROAD TRIP' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a campfire singalong, vintage activity poster with 'CAMPFIRE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing morning meditation, vintage activity poster with 'MEDITATION' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock playing ping pong, vintage activity poster with 'PING PONG' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a sunrise hike summit, vintage activity poster with 'SUMMIT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making snow angels, vintage activity poster with 'SNOW DAY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at an autumn leaf pile, vintage activity poster with 'FALL' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock on a boat at golden hour, vintage activity poster with 'BOATING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a morning coffee ritual, vintage activity poster with 'COFFEE TIME' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock exploring a forest trail, vintage activity poster with 'ADVENTURE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock playing Frisbee in the park, vintage activity poster with 'FRISBEE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a winter ski resort, vintage activity poster with 'SKI SEASON' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making ice cream at home, vintage activity poster with 'ICE CREAM' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock playing mini golf, vintage activity poster with 'MINI GOLF' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock surfing a river wave, vintage activity poster with 'RIVER SURFING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a trampoline park, vintage activity poster with 'JUMP' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making a bonfire on the beach, vintage activity poster with 'BONFIRE NIGHT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at an outdoor movie night, vintage activity poster with 'MOVIE NIGHT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing karate in a dojo, vintage activity poster with 'KARATE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a summer BBQ, vintage activity poster with 'BBQ' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a pie baking contest, vintage activity poster with 'BAKE OFF' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock on a mountain bike trail, vintage activity poster with 'MOUNTAIN BIKING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a sunrise yoga retreat, vintage activity poster with 'SUNRISE YOGA' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing a triathlon, vintage activity poster with 'TRIATHLON' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a harvest festival, vintage activity poster with 'HARVEST TIME' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making sushi together, vintage activity poster with 'SUSHI NIGHT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a spring flower show, vintage activity poster with 'FLOWER SHOW' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock playing lacrosse, vintage activity poster with 'LACROSSE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at an ice hockey rink, vintage activity poster with 'HOCKEY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a sunrise paddle out, vintage activity poster with 'DAWN PATROL' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a garden party, vintage activity poster with 'GARDEN PARTY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a pumpkin carving contest, vintage activity poster with 'PUMPKIN PATCH' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock on a photo walk in the city, vintage activity poster with 'PHOTO WALK' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making a snow fort, vintage activity poster with 'WINTER GAMES' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a morning swim in the lake, vintage activity poster with 'LAKE SWIM' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing weightlifting, vintage activity poster with 'LIFT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a butterfly garden, vintage activity poster with 'BUTTERFLY GARDEN' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a crab boil on the coast, vintage activity poster with 'CRAB FEAST' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making smores in the mountains, vintage activity poster with 'SMORES' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a hot spring soak, vintage activity poster with 'HOT SPRINGS' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a kite surfing beach, vintage activity poster with 'KITE SURFING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a craft beer festival, vintage activity poster with 'BREW FEST' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock on a jungle zip line, vintage activity poster with 'JUNGLE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a sunflower farm, vintage activity poster with 'SUNFLOWER SEASON' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at an art class, vintage activity poster with 'ART CLASS' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing a polar plunge, vintage activity poster with 'POLAR PLUNGE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a morning jog in the park, vintage activity poster with 'MORNING RUN' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a vineyard wine tasting, vintage activity poster with 'WINE TASTING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at an outdoor boxing gym, vintage activity poster with 'BOXING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a sunrise hot yoga session, vintage activity poster with 'HOT YOGA' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a cherry picking farm, vintage activity poster with 'CHERRY SEASON' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a winter cabin getaway, vintage activity poster with 'CABIN LIFE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing a cartwheel in a park, vintage activity poster with 'PLAY TIME' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a forest mushroom hunt, vintage activity poster with 'FORAGING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a lakeside morning paddle, vintage activity poster with 'PADDLE OUT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a neighborhood block party, vintage activity poster with 'BLOCK PARTY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a winter cross-country ski, vintage activity poster with 'CROSS COUNTRY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making homemade pasta, vintage activity poster with 'PASTA NIGHT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a spring festival, vintage activity poster with 'SPRING FEST' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing a sunset jog on the beach, vintage activity poster with 'SUNSET RUN' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a cozy bookstore afternoon, vintage activity poster with 'BOOKSHOP' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a late night stargazing camp, vintage activity poster with 'UNDER THE STARS' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock doing a sunrise beach walk, vintage activity poster with 'SUNRISE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a maple syrup harvest, vintage activity poster with 'MAPLE SEASON' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a summer lemonade stand, vintage activity poster with 'LEMONADE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a night fishing trip, vintage activity poster with 'NIGHT FISHING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a dawn bird call walk, vintage activity poster with 'BIRD WALK' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making maple syrup pancakes, vintage activity poster with 'PANCAKE MORNING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock on a night hike with flashlights, vintage activity poster with 'NIGHT HIKE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a summer sunset sailboat, vintage activity poster with 'SUNSET SAIL' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making homemade ice pops, vintage activity poster with 'SUMMER TREATS' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock on a rowboat at sunset, vintage activity poster with 'ROWBOAT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a fall corn maze, vintage activity poster with 'CORN MAZE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a holiday cookie baking, vintage activity poster with 'COOKIE BAKING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a summer fern forest hike, vintage activity poster with 'FOREST HIKE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a spring kite festival, vintage activity poster with 'KITE FESTIVAL' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making homemade bread, vintage activity poster with 'BREAD DAY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a winter hot cocoa station, vintage activity poster with 'HOT COCOA' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at an outdoor gym session, vintage activity poster with 'WORKOUT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a fall bonfire night, vintage activity poster with 'BONFIRE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a lake morning reflection walk, vintage activity poster with 'LAKESIDE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a summer hammock afternoon, vintage activity poster with 'HAMMOCK TIME' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a twilight firefly walk, vintage activity poster with 'FIREFLY EVENING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at an open air concert, vintage activity poster with 'OUTDOOR CONCERT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a morning smoothie bar, vintage activity poster with 'SMOOTHIE BAR' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a spring farmers picnic, vintage activity poster with 'FARM PICNIC' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a mountain sunrise breakfast, vintage activity poster with 'SUMMIT BREAKFAST' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a lakeside camping weekend, vintage activity poster with 'LAKE CAMP' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a coastline tide pool walk, vintage activity poster with 'TIDE POOLS' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock making a friendship bracelet, vintage activity poster with 'FRIENDSHIP' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a starlit desert camp, vintage activity poster with 'DESERT NIGHT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a spring garden brunch, vintage activity poster with 'GARDEN BRUNCH' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a kayak sea cave explore, vintage activity poster with 'SEA CAVE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a summer waterpark day, vintage activity poster with 'WATERPARK' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a winter igloo sleepover, vintage activity poster with 'IGLOO NIGHT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a tulip picking farm, vintage activity poster with 'TULIP FARM' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a sunrise ocean swim, vintage activity poster with 'OCEAN SWIM' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at an autumn forest run, vintage activity poster with 'TRAIL RUN' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a mountain summit camp, vintage activity poster with 'BASE CAMP' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a coastal kayak sunrise, vintage activity poster with 'KAYAK SUNRISE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a winter baking day, vintage activity poster with 'BAKING DAY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a summer evening swim, vintage activity poster with 'EVENING SWIM' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at an alpine spring walk, vintage activity poster with 'ALPINE WALK' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a county fair ribbon win, vintage activity poster with 'COUNTY FAIR' in bold centered lettering matching the poster colorway, text centered safely away from edges",
  "Snoopy and Woodstock at a weekend retreat in the woods, vintage activity poster with 'RETREAT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a sunrise yoga session, vintage activity poster with 'MORNING YOGA' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a dawn rowing session, vintage activity poster with 'ROWING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a winter ice fishing trip, vintage activity poster with 'ICE FISHING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a sunrise stretch in the park, vintage activity poster with 'STRETCH' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a country line dancing night, vintage activity poster with 'LINE DANCING' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a weekend flea market, vintage activity poster with 'FLEA MARKET' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at an evening firepit, vintage activity poster with 'FIRE PIT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a morning smoothie run, vintage activity poster with 'SMOOTHIE RUN' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a local 5K race, vintage activity poster with '5K RUN' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a beach chair sunset read, vintage activity poster with 'BEACH READ' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a neighborhood walk at dusk, vintage activity poster with 'EVENING WALK' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a spring cleaning day, vintage activity poster with 'SPRING CLEAN' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a winter spa day, vintage activity poster with 'SPA DAY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a coastal cliff run, vintage activity poster with 'CLIFF RUN' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at an outdoor yoga flow, vintage activity poster with 'YOGA FLOW' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a lake house weekend, vintage activity poster with 'LAKE HOUSE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a morning stretch on a hilltop, vintage activity poster with 'HILLTOP' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a forest bathing walk, vintage activity poster with 'FOREST BATH' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a sunrise paddleboard session, vintage activity poster with 'EARLY PADDLE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a mountain meadow run, vintage activity poster with 'MEADOW RUN' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a winter snowflake craft session, vintage activity poster with 'SNOW CRAFT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a creek wading afternoon, vintage activity poster with 'CREEK WALK' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a sand volleyball tournament, vintage activity poster with 'SAND VOLLEY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a sunrise horseback trail ride, vintage activity poster with 'TRAIL RIDE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a mountain biking downhill race, vintage activity poster with 'DOWNHILL' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a summer festival hammock, vintage activity poster with 'FESTIVAL' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a national park overlook, vintage activity poster with 'NATIONAL PARK' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a late night campfire chat, vintage activity poster with 'CAMPFIRE CHAT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a sunrise cross-country ski, vintage activity poster with 'XC SKI' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a seaside town bike tour, vintage activity poster with 'BIKE TOUR' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a mountain photo sunrise shoot, vintage activity poster with 'GOLDEN HOUR' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a summer treehouse build, vintage activity poster with 'TREEHOUSE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a meadow butterfly walk, vintage activity poster with 'BUTTERFLY WALK' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a freshwater kayak tour, vintage activity poster with 'KAYAK TOUR' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a warm summer evening swim, vintage activity poster with 'TWILIGHT SWIM' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a sunrise open water swim, vintage activity poster with 'OPEN WATER' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a winter ski patrol run, vintage activity poster with 'SKI PATROL' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a fall harvest corn maze, vintage activity poster with 'MAZE DAY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a sunrise meditation on a mountain, vintage activity poster with 'MOUNTAIN MIND' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a neighborhood outdoor theater, vintage activity poster with 'OPEN AIR CINEMA' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a spring wildflower walk, vintage activity poster with 'WILDFLOWERS' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a moonlit forest hike, vintage activity poster with 'MOONLIGHT HIKE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a sunrise coastal run, vintage activity poster with 'COASTAL RUN' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a spring garden planting, vintage activity poster with 'GARDEN DAY' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a mountain summit sunrise, vintage activity poster with 'FIRST LIGHT' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a lake sunrise canoe, vintage activity poster with 'CANOE SUNRISE' in bold centered lettering matching the poster colorway, text centered safely away from edges",
"Snoopy and Woodstock at a snowshoe twilight trail, vintage activity poster with 'SNOWSHOE TRAIL' in bold centered lettering matching the poster colorway, text centered safely away from edges",
];
...
async function generateImage(prompt) {
    ...
    var isPoster        = prompt.toLowerCase().includes("activity poster");
    var suffix;
    if (isCartoonRealBg) {
        ...
        suffix = " Generate as a tall vertical 4:5 vintage activity poster. "
            + "Bold graphic design with rich colors and strong composition. Snoopy and Woodstock are the hero illustration. "
            + "The activity word text specified in the prompt must appear centered in the image in large, bold, well-designed lettering. "
            + "The text color must match and complement the poster's overall colorway — harmonious, not clashing. "
            + "Place the text safely in the center of the image, well away from all edges so it will NOT be cropped. "
            + "The text must look professional, legible, and intentional — like a real vintage poster. "
