...
const PROMPTS = [
  ...
  // ── 200 ALBUM COVER STYLE: iconic visual compositions with Snoopy, no artist names ──
  "Snoopy walking barefoot across a zebra crossing with three others in a line, sunny London street, iconic crosswalk album cover",
  "Snoopy as a baby swimming underwater toward a floating dollar bill on a hook, turquoise pool, iconic grunge album cover",
  "Snoopy holding a prism up to a beam of white light splitting into a rainbow spectrum, pure black background, iconic progressive rock album cover",
  "Snoopy in a colorful military band uniform surrounded by a crowd of cardboard celebrity cutouts, Sgt Pepper style, psychedelic album cover",
  "Snoopy in a red leather jacket in a foggy moonlit graveyard surrounded by zombies, iconic pop horror album cover",
  "Snoopy carrying sticks on his back hunched up a hillside at dusk, aged folk album cover, hermit illustration style",
  "Snoopy smashing a guitar against a stage in black and white, London Calling style, punk album cover",
  "Snoopy in glam rock lightning bolt face paint under a Heddon Street lamp at night, Ziggy Stardust style, 1970s glam album cover",
  "Snoopy in a purple trench coat leaning on a motorcycle on a rain-slicked street at dusk, Purple Rain style, album cover",
  "Snoopy in a yellow sundress swinging a baseball bat on a cracked city street in summer, Lemonade style, fierce album cover",
  "Snoopy sitting cross-legged on a pure white background holding a flower, plain minimalist iconic album cover",
  "Snoopy floating in a pool of blue water, face-down on a lilo, seen from above, The River style aerial album cover",
  "Snoopy at the top of stairs in a spotlight in an empty arena, Born to Run style, raw rock album cover",
  "Snoopy in a red hoodie against a plain white wall staring directly into camera, DAMN style, intense album cover",
  "Snoopy as a neon carnival ride mascot head at a psychedelic amusement park, Astroworld style, surreal album cover",
  "Snoopy in a sequined vest doing the moonwalk on a glittering stage floor, Off the Wall style, disco album cover",
  "Snoopy in a leather jacket and chains on a city street at night, Bad style, tough and cool album cover",
  "Snoopy in a graduation cap jumping in front of a cartoon bear mascot stadium, Graduation style, hip-hop album cover",
  "Snoopy in a hospital gown rolling a teddy bear through a hallway, College Dropout style, album cover",
  "Snoopy in a retro silver spacesuit disco suit at a roller rink, Random Access Memories style, golden album cover",
  "Snoopy as a robot dancing in a neon-lit Tokyo future city, Discovery style, electronic album cover",
  "Snoopy in a flowing orange robe sitting cross-legged against an orange wall, Channel Orange style, album cover",
  "Snoopy on a documentary-style rooftop in Compton with his crew, Good Kid MAAD City style, album cover",
  "Snoopy on the White House lawn surrounded by a large group, To Pimp a Butterfly style, black and white",
  "Snoopy in a golden Egyptian pharaoh outfit on a gilded throne, Watch the Throne style, opulent album cover",
  "Snoopy in a misty autumn forest with fallen leaves and a cardigan, Folklore style, soft indie album cover",
  "Snoopy in a polaroid-style photo collage against pastel 1980s backgrounds, 1989 style, pop album cover",
  "Snoopy alone in a snowy mountain landscape at night, blue glow, Kid A style, post-apocalyptic album cover",
  "Snoopy running through snowy woods at night holding sparklers, Funeral style, indie album cover",
  "Snoopy on a suburban street with a bicycle at golden hour, The Suburbs style, nostalgic album cover",
  "Snoopy floating like Superman in clouds above a flat Midwestern town, Illinois style, album cover",
  "Snoopy in a snowy cabin window looking out at a frozen forest, Bon Iver cabin style, isolation album cover",
  "Snoopy in a swamp near a flooded chapel overgrown with vines, Hozier style, gothic southern album cover",
  "Snoopy on a highway overpass at night surrounded by suburban sprawl, OK Computer style, anxious album cover",
  "Snoopy in a rainbow prism light field with warm bokeh, In Rainbows style, album cover",
  "Snoopy as a muted slideshow photo at a childhood home, Carrie and Lowell style, fragile album cover",
  "Snoopy feeding goats at a sunny petting zoo, Pet Sounds style, wholesome beach album cover",
  "Snoopy playing trumpet in a dark blue-lit room, Kind of Blue style, jazz album cover, minimal",
  "Snoopy in a peacoat and scarf on a snow-covered New York street, Blonde on Blonde style, folk album cover",
  "Snoopy sitting at a piano looking out a rainy window, Blue style, introspective folk album cover",
  "Snoopy in a fantasy oil painting on a cliff edge with a phoenix, Dark Twisted Fantasy style, epic album cover",
  "Snoopy sitting on a window seat with a cat on a woven rug, Tapestry style, cozy singer-songwriter cover",
  "Snoopy all in black against a pure black background, Back in Black style, hard rock album cover",
  "Snoopy in a trench coat in the rain outside a church, What's Going On style, soul album cover",
  "Snoopy in bleached hair sitting alone on bleachers, Blonde style, minimal album cover",
  "Snoopy on a hotel room floor surrounded by oranges and fruit, warm tones, Channel Orange style",
  "Snoopy in a neon pink landscape at night alone under rain, 808s Heartbreak style, emotional album cover",
  "Snoopy in a collaged fashion magazine layout with chaotic typography, Life of Pablo style, cover",
  "Snoopy at a control panel in a Paris apartment, Homework style, house music album cover",
  "Snoopy in a funhouse mirror carnival hallway, grainy black and white, Exile on Main St style",
  "Snoopy at a waterfront in a denim jacket looking back over shoulder at dusk, Born to Run style",
  "Snoopy lying on railroad tracks looking up at the sky, The River style, introspective album cover",
  "Snoopy standing in a field of wheat under stormy skies, Nebraska style, stark album cover",
  "Snoopy on a city fire escape at night in the rain, Darkness on the Edge of Town style, album cover",
  "Snoopy on an empty highway at night with headlights behind, Highway to Hell style, rock album cover",
  "Snoopy in an electric chair on a throne wearing a crown, Electric Chair style, provocative album cover",
  "Snoopy in a police lineup with a number board, Straight Outta Compton style, rap album cover",
  "Snoopy holding a gun to his own head in a field, dark concept art album cover, dramatic composition",
  "Snoopy ascending a staircase toward a blinding white light at the top, ambient album cover",
  "Snoopy on a rooftop with arms spread against a stormy sky, liberation album cover composition",
  "Snoopy jumping off a pier into the ocean at dusk, carefree indie album cover, warm tones",
  "Snoopy in a white void standing on a cracking mirror floor, minimalist abstract album cover",
  "Snoopy reflected seven times in a broken mirror kaleidoscope, psychedelic album cover",
  "Snoopy in a bathtub fully clothed reading a book, quirky indie pop album cover",
  "Snoopy dragging a suitcase down an empty airport corridor at dawn, travel pop album cover",
  "Snoopy in a field of red poppies at golden hour, folk rock album cover, lush and cinematic",
  "Snoopy pressing his face against a glass window at night, indie melancholy album cover",
  "Snoopy in a dark forest clearing with a single beam of moonlight, gothic folk album cover",
  "Snoopy standing in the rain on an empty city street at midnight, blue and alone, R&B album cover",
  "Snoopy behind a chain-link fence on a hot city summer day, urban soul album cover",
  "Snoopy on a rooftop at dawn as the sun rises behind skyscrapers, triumphant hip-hop album cover",
  "Snoopy lying in a meadow of clover staring straight up at clouds, indie dream pop album cover",
  "Snoopy in a tunnel mouth with the light behind, atmospheric post-rock album cover",
  "Snoopy rowing a small boat on a still misty lake at dawn, ambient folk album cover",
  "Snoopy at a desolate diner at 3am, country heartbreak album cover, neon and rain outside",
  "Snoopy on a mountain peak with arms raised, triumphant rock album cover, storm clouds parting",
  "Snoopy on a balcony watching a cityscape burn, epic cinematic album cover, orange sky",
  "Snoopy through a fish-eye lens on a basketball court in an empty gym, rap album cover",
  "Snoopy silhouetted in a burning building doorway, dark album cover, intense and dramatic",
  "Snoopy in a mirror ball reflection with colored lights, Saturday Night Fever disco album cover",
  "Snoopy in a sequined blazer under a spotlight, classic Vegas cabaret album cover, warm amber",
  "Snoopy in a smoky jazz bar corner alone, late night jazz album cover, chiaroscuro lighting",
  "Snoopy with a cello on a rooftop at sunset, classical indie album cover, city and strings",
  "Snoopy in flowing white linen on a cliff above the sea, singer-songwriter album cover, pure",
  "Snoopy sitting at a fire escape with headphones watching the city below, lo-fi hip-hop cover",
  "Snoopy in an oversized vintage suit in a wheat field, indie album cover, Talking Heads style",
  "Snoopy on a 1970s orange shag carpet with a bouquet, warm soul album cover, domestic bliss",
  "Snoopy in a diner booth alone at 2am with a cup of coffee, singer-songwriter album cover",
  "Snoopy in a tornado of falling autumn leaves, whimsical indie pop album cover",
  "Snoopy on horseback on a dusty road at sunset, outlaw country album cover, epic western",
  "Snoopy in an empty cathedral with a single candle, spiritual ambient album cover, vast",
  "Snoopy in a crowded subway train pressing against the glass, city pop album cover, rush hour",
  "Snoopy at a rooftop pool party at dusk, Miami pop album cover, warm and glamorous",
  "Snoopy in a forest of giant mushrooms, fantasy folk album cover, Alice in Wonderland feel",
  "Snoopy in a boxing ring after the fight, tape on fists and sweat, triumph album cover",
  "Snoopy at a phone booth in the rain on a lonely road, 80s synth ballad album cover",
  "Snoopy on a snow-covered rooftop at midnight, urban winter album cover, blue and still",
  "Snoopy in a golden wheat field with storm clouds behind, roots album cover, cinematic",
  "Snoopy at a dusty vinyl record flea market, crate-digging album cover, analog warmth",
  "Snoopy in a laundromat at night in the rain, indie film album cover, mundane and beautiful",
  "Snoopy in a Hawaiian shirt on a beach at sunset with a mai tai, sunshine pop album cover",
  "Snoopy in a green field with a rainbow behind after rain, hopeful folk album cover",
  "Snoopy inside a snow globe being shaken, surreal indie album cover, magical and contained",
  "Snoopy on a rusty fire escape with a typewriter, literary indie album cover, gritty and warm",
  "Snoopy in a projection of a forest on a bare wall, art pop album cover, layered and dreamlike",
  "Snoopy sitting on a giant vinyl record floating in the ocean, conceptual album cover",
  "Snoopy in a bathrobe on a penthouse balcony at dawn, introspective pop album cover",
  "Snoopy in front of a burning house calmly drinking coffee, absurdist album cover, meme style",
  "Snoopy in a car at a drive-in theater alone at night, nostalgic album cover, warm screen glow",
  "Snoopy in a library surrounded by toppling stacks of books, literary folk album cover",
  "Snoopy under a streetlamp in an empty parking lot at 3am, lo-fi melancholy album cover",
  "Snoopy on a ferry crossing a grey harbour at dawn, ambient electronic album cover",
  "Snoopy on a rooftop with a cape blowing in the wind, superhero pop album cover, comic style",
  "Snoopy in a crowded mosh pit at a punk show, sweat and energy, live punk album cover",
  "Snoopy sitting on a suitcase in an airport with a one-way ticket, travel album cover",
  "Snoopy on a skateboard in an empty pool, lo-fi skate punk album cover, dusk light",
  "Snoopy in a velvet tuxedo in a Wes Anderson-style symmetrical hotel lobby, indie pop cover",
  "Snoopy in profile against a full moon, folk mysticism album cover, dark and beautiful",
  "Snoopy in a paper boat on a flooded street, rainy day indie album cover, wistful",
  "Snoopy on a tightrope between two skyscrapers at dawn, high-wire album cover, exhilarating",
  "Snoopy in a greenhouse surrounded by tropical plants, botanical ambient album cover, lush",
  "Snoopy watching a solar eclipse with special glasses in a field, science pop album cover",
  "Snoopy running down a hallway toward a door of light, cinematic album cover, hopeful and fast",
  "Snoopy in a darkened theater watching a film alone, cinephile album cover, blue projector light",
  "Snoopy at a country fair on a Ferris wheel at night, nostalgic pop album cover, warm bulb lights",
  "Snoopy in a recording booth with headphones eyes closed, intimate studio album cover",
  "Snoopy slow-dancing alone in an empty ballroom, romantic album cover, chandelier and shadow",
  "Snoopy on a beach at night beside a bioluminescent wave, indie dream album cover",
  "Snoopy in a hot air balloon above patchwork fields at dawn, adventure folk album cover",
  "Snoopy sitting on top of a water tower at sunset overlooking a small town, coming-of-age cover",
  "Snoopy in a rowboat in a flooded library, surreal literary album cover, warm amber underwater",
  "Snoopy in a full mariachi suit in a Mexican plaza at dusk, Latin folk album cover, vibrant",
  "Snoopy in a chef coat at an empty restaurant table with one candle, culinary album cover",
  "Snoopy in a field of lavender in Provence, pastoral French folk album cover, purple and sun",
  "Snoopy on a cargo ship deck at sunset crossing the Pacific, epic travel album cover",
  "Snoopy in a tent during a rainstorm reading by flashlight, cozy camping album cover",
  "Snoopy on roller skates in a neon-lit rink, 1970s boogie album cover, warm and funky",
  "Snoopy in a confetti storm at a surprise party, celebratory pop album cover, joyful chaos",
  "Snoopy in a darkened bedroom with only a phone screen illuminating his face, bedroom pop cover",
  "Snoopy on a cliff watching meteor shower, cosmic indie album cover, awe and small",
  "Snoopy at a desert campfire under the Milky Way, Americana album cover, vast and intimate",
  "Snoopy in black and white on a bridge in the rain, French New Wave album cover, cinematic",
  "Snoopy on a dock with feet in the water at sunset, summer folk album cover, golden and still",
  "Snoopy in a Japanese convenience store at 2am, city pop album cover, fluorescent and lonely",
  "Snoopy in a mirrored elevator looking at infinite reflections, pop art album cover",
  "Snoopy running through an airport to catch a flight, romantic comedy album cover, warm",
  "Snoopy in a darkroom developing his own portrait, meta conceptual album cover, red glow",
  "Snoopy on a skyscraper ledge at sunset looking out over the world, empire state of mind cover",
  "Snoopy in a golden hour desert with a broken guitar, blues rock album cover, dust and warmth",
  "Snoopy riding a merry-go-round horse alone at night, childhood melancholy album cover",
  "Snoopy at a typewriter in a snow-covered cabin, winter writing album cover, cozy isolation",
  "Snoopy at a payphone in the rain on a neon-lit street, 80s heartbreak album cover, warm",
  "Snoopy in a sunflower maze, indie pop album cover, bright and joyful and lost",
  "Snoopy on a rooftop catching snowflakes with his tongue, winter pop album cover, playful",
  "Snoopy in an empty swimming pool at dusk reading a book, literary indie album cover",
  "Snoopy on a long straight road in a desert with heat shimmer, road trip album cover",
  "Snoopy in a cathedral stained glass window backlit, sacred music album cover, radiant",
  "Snoopy in a vintage photo from the 1970s at a backyard barbecue, nostalgia album cover",
  "Snoopy in front of a fireworks display reflecting in a lake, patriotic summer album cover",
  "Snoopy waking up in a field of wildflowers at sunrise, new beginnings album cover, soft",
  "Snoopy on a city rooftop with friends laughing at golden hour, group friendship album cover",
  "Snoopy in a ballet spotlight with a dramatic shadow on the wall, classical modern album cover",
  "Snoopy in a red telephone box in London fog, britpop album cover, iconic British",
  "Snoopy doing the moonwalk on a wet reflective surface, glam pop album cover, theatrical",
  "Snoopy in a stadium surrounded by lighters held up in the dark, live concert album cover",
  "Snoopy in a canoe at the end of a dock as the sun sets, peaceful country album cover",
  "Snoopy on a ferris wheel at the top, looking out over a lit-up city at night, album cover",
