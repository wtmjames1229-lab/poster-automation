...
// Rotating retro color palettes - one is picked at random per image for variety
const COLOR_PALETTES = [
  "teal, cream, mustard yellow, and brick red",
  "hot pink, turquoise, mustard yellow, and cream",
  "burnt orange, deep brown, ochre, and cream",
  "purple, magenta, turquoise, and pale yellow",
  "red, white, navy blue, and cream",
  "lime green, hot pink, sunshine yellow, and cream",
  "navy blue, mustard yellow, cream, and brick red",
  "olive green, mustard, warm brown, and cream",
  "burnt orange, teal, cream, and dark brown",
  "salmon pink, sage green, mustard, and cream",
  "maroon red, mustard yellow, cream, and sage green",
  "cobalt blue, golden yellow, off white, and crimson red",
];
...
function buildStyleSuffix(palette) {
  return " in vintage 1960s pulp comic book cover style, aged distressed paper texture, halftone dot shading, bold black ink outlines, limited retro color palette of " + palette + ", slight registration offset like old print, weathered edges, dynamic action composition, bold colorful flat illustration. Render the title text and ribbon banner text exactly as quoted in the prompt, clearly legible and prominently displayed at the top.";
}
